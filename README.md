...
**Jika Anda memerlukan tambahan module lagi dalam repo atau Jika Anda menemukan bug, silahkan report di group [@DarkRubix](https://www.telegram.dog/SharingUserbot)**
...
#### Deploy in your VPS
````bash
git clone https://github.com/incmaanop/File-Sharing-Man
cd File-Sharing-Man
...
* `START_MESSAGE` Opsional: Pesan /start memulai awalan ke bot, Gunakan <a href='https://github.com/incmaanop/File-Sharing-Man/blob/main/README.md#start_message'>format</a> parsemode HTML 
...
* `CUSTOM_CAPTION` letakkan teks teks Kustom Anda jika Anda ingin Mengatur Teks Kustom, Anda dapat menggunakan HTML dan <a href='https://github.com/incmaanop/File-Sharing-Man/blob/main/README.md#custom_caption'>fillings</a> untuk pemformatan (hanya untuk dokumen)
...
## Support   
Bergabunglah di [Group Telegram ](https://www.telegram.dog/SharingUserbot) Untuk Dukungan/Bantuan Dan Join [Channel](https://www.telegram.dog/DarkRubix) untu info Update bot.   
   
Laporkan Bug, Berikan Permintaan Fitur Di sana.. 

### Credits

- Thanks To Dan For His Awsome [Libary](https://t.me/DarkRubix)
- Thanks To [DarkRubix](https://t.me/DarkRubix)
- Our Support Group Members

### Licence
[![GNU GPLv3 Image](https://www.gnu.org/graphics/gplv3-127x51.png)](http://www.gnu.org/licenses/gpl-3.0.en.html)  

[FILE-SHARING-BOT](https://github.com/incmaanop/File-Sharing-Man/) is Free Software: You can use, study share and improve it at your
